...
//import com.jubiman.customentitylib.tick.Tickable;
...
//	private final HashMap<String, CustomPlayersHandler<? extends CustomEntity>> registry = new HashMap<>();
//
//	/**
...
//	 */
//	public void register(String identifier, CustomPlayersHandler<?> customPlayersHandlerInstance) {
...
//	 */
//	public CustomPlayersHandler<?> get(String identifier) {
...
//	 */
//	public void forEach(BiConsumer<? super String, ? super CustomPlayersHandler<?>> action) {
...
//	 */
//	public void saveAll(SaveData save, ServerClient player) {
...
//	 */
//	public void loadAllEnter(LoadData data) {
...
//	 * @param data the LoadData to load from
//	 */
//	public void loadAllExit(LoadData data) {
//		for (Map.Entry<String, CustomPlayersHandler<?>> entry : registry.entrySet())
...
//	 */
//	public void serverTickAll(Server server) {
//		for (CustomPlayersHandler<?> cps : registry.values())
//			if (cps instanceof Tickable)
//				((Tickable) cps).serverTick(server);
//	}
//
//	/**
...
//	 */
//	public void clientTickAll(Client client) {
//		for (CustomPlayersHandler<?> cps : registry.values())
//			if (cps instanceof Tickable)
//				((Tickable) cps).clientTick(client);
//	}
//}
